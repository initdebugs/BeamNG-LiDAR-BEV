...
class SensorMount:
    ...
    # Per-unit, because the front one is a different instrument: it reaches far
    # enough for AEB to stop from motorway speed, and pays for that with a
    # narrow, dense sweep instead of the 170-degree wedge the others use. See
